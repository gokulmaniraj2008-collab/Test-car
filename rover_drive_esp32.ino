...
void drive(const String& direction, int speed) {
  ...
  if (direction == "forward") {
    setMotor(LEFT_IN1, LEFT_IN2, LEFT_PWM_CH, speed);
    setMotor(RIGHT_IN1, RIGHT_IN2, RIGHT_PWM_CH, speed);
    ...
    setMotor(LEFT_IN1, LEFT_IN2, LEFT_PWM_CH, 0);
    setMotor(RIGHT_IN1, RIGHT_IN2, RIGHT_PWM_CH, 0);
  }
}
...
void setup() {
  ...
  ledcAttachPin(LEFT_EN, LEFT_PWM_CH);
  ledcSetup(RIGHT_PWM_CH, PWM_FREQ, PWM_RESOLUTION);
  ledcAttachPin(RIGHT_EN, RIGHT_PWM_CH);
